...
object ProjectProperties {
    ...
    const val NAME_SPACE_DOMAIN = "com.gugugu.dialog.domain"
    const val NAME_SPACE_DATA = "com.gugugu.dialog.data"
    const val NAME_SPACE_DI = "com.gugugu.dialog.di"
    const val NAME_SPACE_REMOTE = "com.gugugu.dialog.remote"
    const val NAME_SPACE_LOCAL = "com.gugugu.dialog.local"

    const val APPLIACATION_ID = "com.gugugu.dialog"
